...
public class IniziaSfida extends Activity {
	...
	int contatore ; int secondi ; int differenza ; int i ; int x ; int id ;
	Random ra ;
	String url ; String dbName ; String username ; String password ; String driver ; String sql ;
	...
	public void countdown() {	
		...
		Runnable ru = new Runnable() {
			...
			public void run() {
			    ...
			    for(int i = 0 ; differenza != 0 && x != 21 && i <= secondi ; i++){
